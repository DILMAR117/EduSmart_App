...
class AppTextStyles {
  ...
  static final TextStyle bien = GoogleFonts.notoSans(
    color: AppColors.levelButtonTextHard,
    fontSize: 32,
    fontWeight: FontWeight.w600,
  );
   static final TextStyle malo = GoogleFonts.notoSans(
    color: AppColors.darkRed,
    fontSize: 32,
    fontWeight: FontWeight.w600,
  );
   static final TextStyle muybien = GoogleFonts.notoSans(
  ...
  static final TextStyle rakinNombre = GoogleFonts.notoSans(
