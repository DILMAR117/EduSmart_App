...
class _RankingState extends State<Ranking> {
  ...
  List<dynamic> avatar = [];
   List<dynamic> idAlumno = [];
  @override
  void initState() {
    super.initState();
    _conexion.fetchGamificacion();
   ...
   void obtenerLista(){
     ...
     setState(() {
       ...
       idAlumno= data.ranking.map((item) => item['id_alumno']).toList();
     });
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<dynamic>(
        future: _conexion.fetchGamificacion(),
           ...
           return Container(
            ...
            return Container(
                  ...
                  child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                             Text("Rankin aun no esta disponible",
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    '#',
                                    style: AppTextStyles.rakinNombre
                                  ),
                                  const Spacer(),
                                 const CircleAvatar(
                                    radius: 27,
                                ...
                                return Column(
                                  children: [
                                    Container(
                                      width: MediaQuery.of(context).size.width,
                                      height: 68,
                                      color: const Color(0xff060718).withOpacity(0.8),
                                      child: Padding(
                                               ...
                                               const SizedBox(
                                                ...
                                                CircleAvatar(
                                                  ...
                                                  backgroundColor:const 
                                                      Color(0xffA6BAFC),
                                                  child: CircleAvatar(
                                                    backgroundImage: NetworkImage('http://${_conexion.ip}/get-image/${data['foto']}'),
                                                    radius: 21,
                                                  ),
                                                ),
                                               const SizedBox(
            ...
            Container(
              ...
              child:  CircleAvatar(
                ...
                child: CircleAvatar(
                    ...
                    child: CircleAvatar(
                        backgroundImage: NetworkImage('http://${conexion.ip}/get-image/${avatar[0]}'),
                        radius: 50,
                        )),
              ),
            ),
           ...
           Container(
            ...
            child: CircleAvatar(
              ...
              child: CircleAvatar(
                  ...
                  child: CircleAvatar(
                      radius: 33,
                      backgroundImage: NetworkImage('http://${conexion.ip}/get-image/${avatar[2]}'))),
            ),
          ),
          Positioned(
              top: .0,
          ...
          Container(
            ...
            child:  CircleAvatar(
              ...
              child: CircleAvatar(
                  ...
                  child: CircleAvatar(
                      backgroundImage: NetworkImage('http://${conexion.ip}/get-image/${avatar[1]}'),
                      radius: 33,)),
            ),
          ),
          Positioned(
